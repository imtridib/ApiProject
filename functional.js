...
// //               onclick="loadPetByCategory(${item.id})" 
...
//   categories.forEach((item) => {
//     // use category name as the ID (safe for button toggle)
...
//               class="px-4 py-2 w-56 h-20 bg-[rgba(14,122,129,0.15)] hover:bg-teal-600 text-black text-2xl border border-black rounded-lg mb-4 flex items-center justify-center gap-2">
